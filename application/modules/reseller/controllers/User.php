...
class User extends Reseller_Controller {
	...
	public function create_user () {
	    $this->render('user/add_app_user');
    }

    public function all_users () {
        $crud = $this->generate_crud('users');
        $crud->columns('id', 'user', 'password', 'copy', 'phone', 'user_type','created_date','expire_date','status','created_by');
        $this->unset_crud_fields('ip_address', 'last_login');
    ...
    public function render_user_crud () {
